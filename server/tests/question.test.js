...
describe('question util module', () => {
    ...
    test('get most viewed questions', async () => {
        mockingoose(Question).toReturn(_questions, 'find');

        const result = await getQuestionsByOrder('views');
    ...
    test('get most viewed questions', async () => {
        ...
        const result = await getQuestionsByOrder('comments');
    ...
    test('get most commented questions', async () => {
        mockingoose(Question).toReturn(_questions, 'find');
